# 4节点 DeepSeek-V4-Pro 性能测试（TP=4 DP=2 PP=4，有 HiCache，mem=0.95，swa=0.2，chunked-prefill-size=4096）
...
- pp-size: 4
- enable-dp-attention: 是
- GPU 规划: 4 节点 * 8 GPU = 32 GPU；TP=4 * PP=4 * DP=2 = 32 GPU

...
| 模型             | Hardware      | Cards | 部署 Mode       | Dataset   | TPOT | 量化 | 配置                                                                             |
|-------------------|---------------|-------|-------------------|-----------|------|--------------|-------------------------------------------------------------------------------------------|
| Deepseek-R1       | Atlas 800I A3 | 32    | PD 分离 | 6K+1.6K   | 20ms | W8A8 INT8    | [Optimal 配置](#deepseek-r1-6k-1_6k-20ms-on-a3-32-cards-disaggregation-mode)     |
| Deepseek-R1       | Atlas 800I A3 | 32    | PD 分离 | 3.9K+1K   | 19ms | W8A8 INT8    | [Optimal 配置](#deepseek-r1-3_9k-1k-19ms-on-a3-32-cards-disaggregation-mode)     |
| Deepseek-R1       | Atlas 800I A3 | 32    | PD 分离 | 3.5K+1.5K | 19ms | W8A8 INT8    | [Optimal 配置](#deepseek-r1-3_5k-1_5k-19ms-on-a3-32-cards-disaggregation-mode)   |
| Deepseek-R1       | Atlas 800I A3 | 32    | PD 分离 | 3.5K+1K   | 19ms | W8A8 INT8    | [Optimal 配置](#deepseek-r1-3_5k-1k-19ms-on-a3-32-cards-disaggregation-mode)     |
| DeepSeek-V3.2     | Atlas 800I A3 | 32    | PD 分离 | 128K+1K   | 26ms | W8A8 INT8    | [Optimal 配置](#deepseek-v32-128k-1k-26ms-on-a3-32-cards-disaggregation-mode)    |

### High Throughput

| 模型       | Hardware      | Cards | 部署 Mode       | Dataset   | TPOT | 量化 | 配置                                                                           |
|-------------|---------------|-------|-------------------|-----------|------|--------------|-----------------------------------------------------------------------------------------|
| Deepseek-R1 | Atlas 800I A3 | 32    | PD 分离 | 3.5K+1.5K | 50ms | W8A8 INT8    | [Optimal 配置](#deepseek-r1-3_5k-1_5k-50ms-on-a3-32-cards-disaggregation-mode) |
| Deepseek-R1 | Atlas 800I A3 | 24    | PD 分离 | 2K+2K     | 50ms | W8A8 INT8    | [Optimal 配置](#deepseek-r1-2k-2k-50ms-on-a3-24-cards-disaggregation-mode)     |
| Deepseek-R1 | Atlas 800I A3 | 8     | PD Mixed          | 2K+2K     | 50ms | W4A8 INT8    | [Optimal 配置](#deepseek-r1-2k-2k-50ms-on-a3-8-cards-mixed-mode)               |
| Deepseek-R1 | Atlas 800I A3 | 16    | PD 分离 | 2K+2K     | 50ms | W4A8 INT8    | [Optimal 配置](#deepseek-r1-2k-2k-50ms-on-a3-16-cards-disaggregation-mode)     |
| Deepseek-R1 | Atlas 800I A3 | 8     | PD Mixed          | 3.5K+1.5K | 50ms | W4A8 INT8    | [Optimal 配置](#deepseek-r1-3_5k-1_5k-50ms-on-a3-8-cards-mixed-mode)           |
| Deepseek-R1 | Atlas 800I A3 | 16    | PD 分离 | 3.5K+1.5K | 50ms | W4A8 INT8    | [Optimal 配置](#deepseek-r1-3_5k-1_5k-50ms-on-a3-16-cards-disaggregation-mode) |
...
| 模型                   | Hardware      | Cards | 部署 Mode | Dataset   | TPOT    | 量化 | 配置                                                                      |
|-------------------------|---------------|-------|-------------|-----------|---------|--------------|------------------------------------------------------------------------------------|
| Qwen3-235B-A22B         | Atlas 800I A3 | 8     | PD Mixed    | 11K+1K    | 10ms    | BF16         | [Optimal 配置](#qwen3-235b-a22b-11k-1k-10ms-on-a3-8-cards-mixed-mode)     |
| Qwen3-32B               | Atlas 800I A3 | 4     | PD Mixed    | 6K+1.5K   | 18ms    | BF16         | [Optimal 配置](#qwen3-32b-6k-1_5k-18ms-on-a3-4-cards-mixed-mode)          |
| Qwen3-32B               | Atlas 800I A3 | 4     | PD Mixed    | 4K+1.5K   | 11ms    | BF16         | [Optimal 配置](#qwen3-32b-4k-1_5k-11ms-on-a3-4-cards-mixed-mode)          |
| Qwen3-32B               | Atlas 800I A3 | 8     | PD Mixed    | 18K+4K    | 6ms     | BF16         | [Optimal 配置](#qwen3-32b-18k-4k-6ms-on-a3-8-cards-mixed-mode)            |
| Qwen3-32B               | Atlas 800I A2 | 8     | PD Mixed    | 6K+1.5K   | 18ms    | W8A8 INT8    | [Optimal 配置](#qwen3-32b-6k-1_5k-18ms-on-a2-8-cards-mixed-mode)          |
| Qwen3-32B               | Atlas 800I A2 | 8     | PD Mixed    | 4K+1.5K   | 11ms    | BF16         | [Optimal 配置](#qwen3-32b-4k-1_5k-11ms-on-a2-8-cards-mixed-mode)          |
| Qwen3-32B               | Atlas 800I A3 | 2     | PD Mixed    | 1K+0.3K   | 12ms    | W8A8 INT8    | [Optimal 配置](#qwen3-32b-1k-0_3k-12ms-on-a3-2-cards-mixed-mode)          |
| Qwen3-32B               | Atlas 800I A3 | 2     | PD Mixed    | 6K+1.5K   | 17ms    | W8A8 INT8    | [Optimal 配置](#qwen3-32b-6k-1_5k-17ms-on-a3-2-cards-mixed-mode)          |
| Qwen3-8B                | Atlas 800I A3 | 1     | PD Mixed    | 1K+0.3K   | 7ms     | W8A8 INT8    | [Optimal 配置](#qwen3-8b-1k-0_3k-7ms-on-a3-1-cards-mixed-mode)            |
| Qwen3-8B                | Atlas 800I A3 | 1     | PD Mixed    | 6K+1.5K   | 12ms    | W8A8 INT8    | [Optimal 配置](#qwen3-8b-6k-1_5k-12ms-on-a3-1-cards-mixed-mode)           |
| Qwen3-8B                | Atlas 800I A3 | 1     | PD Mixed    | 3.5K+1.5K | 5ms     | W8A8 INT8    | [Optimal 配置](#qwen3-8b-3_5k-1_5k-5ms-on-a3-1-cards-mixed-mode)          |
| Qwen3-30B-A3B           | Atlas 800I A3 | 1     | PD Mixed    | 6K+1.5K   | 10ms    | W8A8 INT8    | [Optimal 配置](#qwen3-30b-a3b-6k-1_5k-10ms-on-a3-1-cards-mixed-mode)      |
| Qwen3-30B-A3B           | Atlas 800I A3 | 1     | PD Mixed    | 1K+0.3K   | 7ms     | W8A8 INT8    | [Optimal 配置](#qwen3-30b-a3b-1k-0_3k-7ms-on-a3-1-cards-mixed-mode)       |
| Qwen3-Next-A3B-Instruct | Atlas 800I A3 | 2     | PD Mixed    | 1K+0.3K   | 14.21ms | W8A8 INT8    | [Optimal 配置](#qwen3-next-1k-0_3k-14_21ms-on-a3-2-cards-mixed-mode)      |
| Qwen3-Next-A3B-Instruct | Atlas 800I A3 | 2     | PD Mixed    | 6K+1.5K   | 15.62ms | W8A8 INT8    | [Optimal 配置](#qwen3-next-6k-1_5k-15_62ms-on-a3-2-cards-mixed-mode)      |
| Qwen3-Next-A3B-Instruct | Atlas 800I A3 | 2     | PD Mixed    | 3.5K+1.5K | 20ms    | W8A8 INT8    | [Optimal 配置](#qwen3-next-3_5k-1_5k-20ms-on-a3-2-cards-mixed-mode)       |
| Qwen3-14B               | Atlas 800I A3 | 1     | PD Mixed    | 3.5K+1.5K | 9ms     | W8A8 INT8    | [Optimal 配置](#qwen3-14b-3_5k-1_5k-9ms-on-a3-1-cards-mixed-mode)         |
| Qwen3.5-397B-A17B       | Atlas 800I A3 | 8     | PD Mixed    | 3.5K+1.5K | 22ms    | W4A8         | [Optimal 配置](#qwen35-397B-a17b-3_5k-1_5k-22ms-on-a3-8-cards-mixed-mode) |

### High Throughput

| 模型                          | Hardware      | Cards | 部署 Mode       | Dataset   | TPOT  | 量化 | 配置                                                                                              |
|--------------------------------|---------------|-------|-------------------|-----------|-------|--------------|------------------------------------------------------------------------------------------------------------|
| Qwen3-235B-A22B                | Atlas 800I A3 | 24    | PD 分离 | 3.5K+1.5K | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-235b-a22b-3_5k-1_5k-50ms-on-a3-24-cards-disaggregation-mode)                |
| Qwen3-235B-A22B                | Atlas 800I A3 | 8     | PD Mixed          | 3.5K+1.5K | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-235b-a22b-3_5k-1_5k-50ms-on-a3-8-cards-mixed-mode)                          |
| Qwen3-235B-A22B                | Atlas 800I A3 | 8     | PD Mixed          | 2K+2K     | 100ms | W8A8 INT8    | [Optimal 配置](#qwen3-235b-a22b-2k-2k-100ms-on-a3-8-cards-mixed-mode)                             |
| Qwen3-235B-A22B                | Atlas 800I A3 | 8     | PD Mixed          | 2K+2K     | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-235b-a22b-2k-2k-50ms-on-a3-8-cards-mixed-mode)                              |
| Qwen3-235B-A22B                | Atlas 800I A3 | 16    | PD Mixed          | 2K+2K     | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-235b-a22b-2k-2k-50ms-on-a3-16-cards-mixed-mode)                             |
| Qwen3-32B                      | Atlas 800I A3 | 2     | PD Mixed          | 3.5K+1.5K | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-32b-3_5k-1_5k-50ms-on-a3-2-cards-mixed-mode)                                |
| Qwen3-32B                      | Atlas 800I A3 | 2     | PD Mixed          | 2K+2K     | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-32b-2k-2k-50ms-on-a3-2-cards-mixed-mode)                                    |
| Qwen3-30B-A3B                  | Atlas 800I A3 | 1     | PD Mixed          | 3.5K+1.5K | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-30b-a3b-3_5k-1_5k-50ms-on-a3-1-card-mixed-mode)                             |
| Qwen3-Coder-480B-A35B-Instruct | Atlas 800I A3 | 24    | PD 分离 | 3.5K+1.5K | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-coder-480b-a35b-instruct-3_5k-1_5k-50ms-on-a3-24-cards-disaggregation-mode) |
| Qwen3-Coder-480B-A35B-Instruct | Atlas 800I A3 | 16    | PD Mixed          | 3.5K+1.5K | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-coder-480b-a35b-instruct-3_5k-1_5k-50ms-on-a3-16-cards-mixed-mode)          |
| Qwen3-Coder-480B-A35B-Instruct | Atlas 800I A3 | 8     | PD Mixed          | 3.5K+1.5K | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-coder-480b-a35b-instruct-3_5k-1_5k-50ms-on-a3-8-cards-mixed-mode)           |
| Qwen3-Next-80B-A3B-Instruct    | Atlas 800I A3 | 2     | PD Mixed          | 3.5K+1.5K | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-next-80B-a3b-instruct-3_5k-1_5k-50ms-on-a3-2-cards-mixed-mode)              |
| Qwen3-32B                      | Atlas 800I A2 | 8     | PD Mixed          | 3.5K+1.5K | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-32b-3_5k-1_5k-50ms-on-a2-8-cards-mixed-mode)                                |
| Qwen3-32B                      | Atlas 800I A2 | 8     | PD Mixed          | 2K+2K     | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-32b-2k-2k-50ms-on-a2-8-cards-mixed-mode)                                    |
| Qwen3-14B                      | Atlas 800I A3 | 1     | PD Mixed          | 3.5K+1.5K | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-14b-3_5k-1_5k-50ms-on-a3-1-cards-mixed-mode)                                |
| Qwen3-8B                       | Atlas 800I A3 | 1     | PD Mixed          | 3.5K+1.5K | 50ms  | W8A8 INT8    | [Optimal 配置](#qwen3-8b-3_5k-1_5k-50ms-on-a3-1-cards-mixed-mode)                                 |
| Qwen3.5-397B-A17B              | Atlas 800I A3 | 8     | PD Mixed          | 3.5K+1.5K | 50ms  | W4A8         | [Optimal 配置](#qwen35-397B-a17b-3_5k-1_5k-50ms-on-a3-8-cards-mixed-mode)                         |

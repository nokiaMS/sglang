...
W4A8 模型 weights could be found [here](https://modelers.cn/models/Modelers_Park/DeepSeek-R1-0528-w4a8).
...
3. SGLang 模型 Gateway (former 路由器)
...
W8A8 模型 weights could be found [here](https://modelers.cn/models/State_Cloud/Deepseek-R1-bf16-hfd-w8a8).
...
2. SGLang 模型 Gateway (former 路由器):

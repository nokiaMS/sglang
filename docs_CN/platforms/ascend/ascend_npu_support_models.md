...
This section describes the models supported on the Ascend NPU, including Large Language 模型, Multimodal Language
模型, 嵌入模型, 奖励模型 and Rerank 模型. Mainstream DeepSeek/Qwen/GLM series are included.
You are welcome to enable various models based on your business requirements.

## Large Language 模型

| 模型                                     | 模型 Family                   |               A2 已支持               |               A3 已支持               |
|--------------------------------------------|--------------------------------|:----------------------------------------:|:----------------------------------------:|
...
| 模型                                        | 模型 Family (Variants)   |               A2 已支持               |               A3 已支持               |
|-----------------------------------------------|---------------------------|:----------------------------------------:|:----------------------------------------:|

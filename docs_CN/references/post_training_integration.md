...
- 训练 服务化 Alignment: ensure the performance consistency in training and serving
- Load Balancing 路由器: cache-aware load-balancing for high-throughput rollout
- 确定性推理: ensure zero kl divergence between rollout and training
...
- [**ROLL**](https://github.com/alibaba/ROLL): ROLL is an efficient and user-friendly RL library designed for Large Language 模型 utilizing Large Scale GPU resources

...
注意 that LLama 405B (fp8) can also be launched on a single node.
...
请参考 [DeepSeek documents for reference](/docs_CN/basic_usage/deepseek_v3.md#running-examples-on-multi-node).

## Multi-Node 推理 on SLURM
...
Then, you can test the server by sending requests following other [documents](/docs_CN/basic_usage/openai_api_completions.md).

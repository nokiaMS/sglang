...
*注意: The NodeSelector section, model location section, and taint toleration section can be adjusted according to your actual deployment environment*
...
目前, we use a static K8S service + minilb approach to implement model API calls.
...
2. Some preset, optimized configurations for EPLB are not used here. 你可以 adjust them according to [6017](https://github.com/sgl-project/sglang/issues/6017) as needed.

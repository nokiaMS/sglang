...
| 参数 | 说明 |
|----------|-------------|
| `--enable-frame-interpolation` | Enable frame interpolation. 模型 weights are downloaded automatically on first use. |
...
示例 — generate 5 frames, interpolate to 9 frames, and upscale each frame
by 4×:

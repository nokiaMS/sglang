...
|----------------|--------------|
| `monolithic` | (默认值) Standard single-server mode |
...
### Single-Machine 示例 (Verified)

以下 commands have been tested end-to-end on an 8×H200 machine with
...
> **提示:** `--base-gpu-id` controls which physical GPU the role uses.

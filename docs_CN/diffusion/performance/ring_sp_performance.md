...
# Ring SP 基准测试: Wan2.2-TI2V-5B (u1r2 vs Baseline)

本页面 reports Ring-SP performance for `Wan2.2-TI2V-5B-Diffusers` using:
...
| 内存 Metric | `u1r2` (GB) | `u1r1` baseline (GB) | Delta |
|---|---:|---:|---:|
| Peak GPU 内存 | 20.07 | 27.40 | -7.33 |
| Peak Allocated | 13.35 | 20.40 | -7.05 |
| 内存 Overhead | 6.72 | 7.00 | -0.28 |

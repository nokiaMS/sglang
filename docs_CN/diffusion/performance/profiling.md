...
# 性能分析 Multimodal Generation

本指南 covers profiling techniques for multimodal generation pipelines in SGLang.

## PyTorch Profiler

PyTorch Profiler provides detailed kernel execution time, call stack, and GPU utilization metrics.

### Denoising Stage 性能分析
...
- `--num-profiled-timesteps N`: Number of timesteps to profile after warmup (default: 5)
  ...
  - 示例: `--num-profiled-timesteps 10` profiles 10 steps after 1 warmup step
...
默认情况下, trace files are saved in the ./logs/ directory.
...
See the [SGLang profiling guide](/docs_CN/developer_guide/benchmark_and_profiling.md#profile-with-nsight) for installation instructions.

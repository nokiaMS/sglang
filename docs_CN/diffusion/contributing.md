...
# Contributing to SGLang 扩散模型

本指南 outlines the requirements for contributing to the SGLang 扩散模型 module (`sglang.multimodal_gen`).

## Contributor Guides

- [支持新模型](support_new_models.md): implementation guide for adding new diffusion pipelines
- [CI 性能](ci_perf.md): update and regenerate perf baselines

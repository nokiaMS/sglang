...
If you are unsure if a specific architecture is implemented, you can search for it via GitHub. 例如, to search for `Qwen3ForCausalLM`, use the expression:
...
| 模型 Family (Variants)             | 示例 HuggingFace Identifier                     | 说明                                                                            |
|-------------------------------------|--------------------------------------------------|----------------------------------------------------------------------------------------|
...
| **OLMo** (2, 3) | `allenai/OLMo-3-1125-32B`, `allenai/OLMo-3-32B-Think`, `allenai/OLMo-2-1124-7B-Instruct` | Allen AI’s series of Open Language 模型 designed to enable the science of language models. |

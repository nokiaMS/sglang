...
- **性能 Trends**: View throughput, latency, and TTFT trends over time
- **模型 Comparison**: Compare performance across different models and configurations
...
### Option 1: Run with Local 服务器 (Recommended)
